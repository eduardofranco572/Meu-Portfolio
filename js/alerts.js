...
alert4.addEventListener('click', function(event) {
    Swal.fire(
        '<h1 class="alerttitulo"> Estão listados 21 projetos no meu GitHub, mais eu realizei muito mais projetos, ao decorrer do curso técnico e desse 1,5 anos</h1>'
        )
});